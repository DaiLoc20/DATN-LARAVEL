...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
          <a class="navbar-brand name" href="/Admin/Category/CategoryList">
            <i class="bi bi-window"></i>
            <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-window icon-category" viewBox="0 -2 15 22"> <path d="M2.5 4a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1m2-.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0m1 .5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1"/><path d="M2 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2zm13 2v2H1V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1M2 14a1 1 0 0 1-1-1V6h14v7a1 1 0 0 1-1 1z"/> </svg>
            LOẠI SẢN PHẨM
          </a>
    ...
    <!-- Bảng Loại Sản Phẩm Cha-->
        ...
        <thead class="table-backgroupColor">
            <tr>
                ...
                <th scope="col" class="parent-border-th-img">HÌNH ẢNH</th>
                <th scope="col" class="parent-border-th-function">CHỨC NĂNG</th>
            </tr>
        </thead>
        <tbody>
            @php
            $stt = ($parentCategories->currentPage() - 1) * $parentCategories->perPage() + 1;
            @endphp
            ...
            <tr>
                ...
                <td class="parent-border-td-img">
                    @foreach($parent->images as $image)
                        <img class="img-parent" src="{{ $image->path }}" alt="{{ $parent->name }}">
                    @endforeach
                </td>
    ...
    <table class="table Children">
        ...
        <tbody>
            @php
            $stt = ($childCategories->currentPage() - 1) * $childCategories->perPage() + 1;
            @endphp
