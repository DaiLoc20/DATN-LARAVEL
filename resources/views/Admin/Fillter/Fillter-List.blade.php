        ...
        <div class="button-group group-function">
           ...
           <button class="btn btn-success plus-fillter" >
            ...
            <button class="btn btn-success show-new-fillter">
                <a class="nav-link" href="{{ route('admin.fillter.list', ['sort' => $sort, 'show_new' => true]) }}">HIỂN THỊ FILLTER MỚI TẠO </a>
            </button>

            <button class="btn btn-success show-edit-fillter">
               <a class="nav-link"href="{{ route('admin.fillter.list', ['sort' => $sort, 'show_edited' => true]) }}">HIỂN THỊ FILLTER VỪA CHỈNH SỬA</a>
            </button>
