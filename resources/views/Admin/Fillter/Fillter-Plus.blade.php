...
<head>
    ...
    <link href="/css/Fillter_Plus_Admin.css" rel="stylesheet">
    <title> THÊM BỘ LỌC SẢN PHẨM | FILLTER PRODUCT | </title>
</head>
<body>
    @extends('Layouts.Layout_Admin')
    @section('title','Fillter-Plus')
    ...
    @section('content')
      ...
      <nav style="--bs-breadcrumb-divider: '/'" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a>THÊM BỘ LỌC ( PARENT - CHILDREN )</a></li>
        </ol>
     </nav>

    <div class="form-FillterPlus">
        <form action="{{ route('admin.fillter.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="coolinput col-md-6">
                <label for="name" class="text">Tên Bộ Lọc:</label>
                <input type="text" class="input form-control " id="name" name="name" required>
            </div>

            <div class="coolinput col-md-6">
                <label for="is_parent" class="text">Loại Bộ Lọc</label>
