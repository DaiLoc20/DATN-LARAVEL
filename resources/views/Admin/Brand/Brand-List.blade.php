...
<body>
    ...
    @section('content')
        ...
        <nav class="navbar nav-function">
            <div class="button-group group-function">
                <button class="btn btn-primary show-all-brand" >
               ...
               <button class="btn btn-primary plus-brand" >
               ...
               <button class="btn btn-warning show-edit-brand">
            ...
            <form class="d-flex form-search" role="search">
                <input class="form-control me-2 font-search" type="search" placeholder="Tìm kiếm ..." aria-label="Search">
                <button class="btn btn-search" type="submit">
                    <i class="bi bi-search"></i><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/> </svg>
                </button>
            </form>
       </nav>
    ...
    <script src="{{ asset('js/delete-brand-form.js') }}"></script>
